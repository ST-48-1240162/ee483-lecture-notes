...
\begin{align*}
  ...
  &= \sum_k x[k]\,h[n-k]. && \text{(time-invariance)} \MitraTag{2.20a,\ 4.16a}
\end{align*}
...
\textbf{sufficient} condition for BIBO stability.
...
is \textbf{necessary} that $\displaystyle\sum_{k=-\infty}^{\infty}|h[k]| < \infty$.
